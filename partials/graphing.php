...
<script src='/njtransit/partials/getCensusVariableName.js'></script>
<script>
...
{
	var xml = 'partials/acs_5yr_2011_var.xml';
...
<div id="income_graph"> <div style= "Float:left;font-size:75%;"id="income_graph_legend"> </div>
</div></div>

<h2>Transportation to Work</h2>
<div class='graph_container'>
<div id="transport_graph"><div style= "Float:left;font-size:75%;" id="transport_graph_legend"></div></div>
